	...
	(0, _createClass3.default)(ZaloOA, [{
		...
		value: function value(path, method, params, cb) {
			var url,
			    ...
			    isMultipart = false;
			cb = cb || function () {};
			url = 'https://openapi.zalo.me/' + this.options('version') + '/oa/' + path;
			...
			if (path == 'getprofile') {
				url = 'https://openapi.zalo.me/' + this.options('version') + '/oa/' + path + '?access_token=' + this.options('secretkey') + '&data={"user_id":"' + params.uid + '"}';
			}
			...
			console.log(this.options('secretkey'));
			console.log(url);
			console.log(params);
